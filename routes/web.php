...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    // admin auth
    Route::middleware(['auth:admin', 'isblocked', 'isdeleted'])->group(function () {
        Route::get('/', [
        ...
        Route::get('/servers/add/renewal/{serverid}/{userid}/{packageid}', [
            App\Http\Controllers\Admin\ServerController::class,
            'renewal',
        ])->name('add.renewal.server');

        // Report
        Route::get('/report/server/payment', [
            App\Http\Controllers\Admin\ReportController::class,
            'serverPayment',
        ])->name('report.server.payment');
        Route::get('/report/server/payment/filter', [
            App\Http\Controllers\Admin\ReportController::class,
            'serverPaymentFilter',
