...
<body>
    ...
    <section class="body">
            ...
            <div class="header-right">
                ...
                <div class="search nav-form">
                    <input type="text" class="form-control"
                        value="$ : {{ getUserCurrentBalance(Auth::guard('web')->user()->id) }}"
                ...
                <div id="userbox" class="userbox">
                    <a href="#" data-toggle="dropdown">
                        <figure class="profile-picture">
                            @php
                                $profile = Auth::guard('web')->user()->image != '' ? asset('uploads/user') . '/' . Auth::guard('web')->user()->image : asset('assets/images/!logged-user.jpg');
                            @endphp
                            <img src="{{ $profile }}" alt=" {{ Auth::guard('web')->user()->name }}"
                                class="img-circle" data-lock-picture="{{ $profile }}" />
                        </figure>
                        <div class="profile-info" data-lock-name="{{ Auth::guard('web')->user()->name }}"
                            data-lock-email="{{ Auth::guard('web')->user()->email }}">
                            <span class="name">
                    ...
                    <div class="dropdown-menu">
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <a role="menuitem" tabindex="-1" href="{{ route('password') }}"><i
        ...
        <div class="inner-wrapper">
                        ...
                        <nav id="menu" class="nav-main" role="navigation">
                            <ul class="nav nav-main">
                                ...
                                <li class="nav-parent">
                                    ...
                                    <ul class="nav nav-children">
                                        <li>
                                            <a href="{{ route('order.server.add') }} ">
                                                Add Order Server
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('order.server.list') }} ">
                                                List Order Server
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-parent">
                                    ...
                                    <ul class="nav nav-children">
                                        <li>
                                            ...
                                            <a href="{{ route('server.available') }}">
                                                Available Server
                                            </a>
                                            <a href="{{ route('server.expired') }}">
                                                Expired Server
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-parent">
                                    ...
                                    <ul class="nav nav-children">
                                        <li>
                                            <a href="{{ route('technicalsupport.add') }} ">
                                                Add Technical Support
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('technicalsupport.list') }} ">
            ...
            <!-- end: content -->
            <section role="main" class="content-body pt-5 pb-5" style="padding-top: 0;padding-bottom: 0%; ">
    ...
    <script>
        $(document).ready(function() {
            ...
            // const url = "{{ url('sales/unseen/count') }}" + "/" + timeStamp;
            const salesUrl = "{{ url('sales/unseen/count') }}";
            $.ajax({
                url: salesUrl,
                type: "GET",
            ...
            const supportUrl = "{{ url('support/unseen/count') }}";
            $.ajax({
                url: supportUrl,
                type: "GET",
                success: function(response) {
            ...
            const serverUrl = "{{ url('server/unseen/count') }}";
            $.ajax({
                url: serverUrl,
                type: "GET",
                success: function(response) {
