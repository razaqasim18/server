            ...
            <div class="col-md-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h2 class="panel-title">Edit Knowledeg Base</h2>
                    </header>
                    <form class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data"
                        action="{{ route('admin.knowledge.update', ['id' => $knowledge->id]) }}">
                        @csrf
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="title" name="title"
                                        value="{{ $knowledge->title }}" required>
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea name="message" id="summernote">{{ $knowledge->description }}</textarea>
                                    @error('message')
