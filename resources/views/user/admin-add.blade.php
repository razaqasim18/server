    ...
    <div class="row">
        <div class="col-md-12">
            <section class="panel">
                ...
                <form class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data"  action="{{ route('admin.users.insert')}}">
                    @csrf
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                                @php $oldvalue = (old('is_admin') != '') ? old('is_admin'): ''; @endphp
