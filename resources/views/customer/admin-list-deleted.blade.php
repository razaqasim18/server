    ...
    <section role="main" class="content-body">
        ...
        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title">Deleted Customers List</h2>
                    ...
                    <tbody>
                        ...
                        @foreach ($customers as $row)
                            <tr>
                                ...
                                <td>
                                    <button title="restore back" id="restoreUser" data-id="{{ $row->customerid }}"
                                        class="btn btn-primary btn-xs m-1" style="margin:1px">
                                        <i class="fa fa-mail-reply"></i> Restore
                                    </button>
                                </td>
                            </tr>
                        @endforeach
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#datatable-default").on("click", "button#restoreUser", function() {
                var id = $(this).data("id");
                swal({
                        title: 'Are you sure?',
